...
//import '../../../ViewModel/Registration_View_Models/register_firebase_view_model.dart';
import '../../../ViewModel/Registration_View_Models/registration_view_model.dart';

class RegistrationResponderView extends StatefulWidget {
  const RegistrationResponderView({super.key});

  @override
  State<RegistrationResponderView> createState() => _RegistrationResponderViewState();
}
...
class _RegistrationResponderViewState extends State<RegistrationResponderView> {
  //DefaultBox height
  double _whiteContainerHeight = 680.r + 40.r;
